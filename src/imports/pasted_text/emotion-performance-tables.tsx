...
**Section 3 already exists but should be completely replaced with the design below.**
Do not create a new section — update the existing Section 3.
...
Only include emotions that have at least **5 trades**.

Emotions with fewer than 5 trades should not appear in the tables.
